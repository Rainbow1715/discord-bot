...
# 🆕 新キャラ実装・ピックアップ設定
NEW_PICKUP_CHARACTERS = ["ロイ", "折原和也", "神明龍矢", "サラ"]  # 実装時に ["新キャラ名"] を指定
...
ADULT_CHARACTERS = [
    "折原和也", "橘柊人", "竹村しえら", "れーちゃん", "Gerânio", "レオ", "ロイ", "白黒レイ", "神明龍矢", "サラ",
]
...
SUSPICIOUS_MEAT_CHARACTERS = [
    "Branch Coral", "Root Coral", "ロイ", "折原和也", "サラ",
]
