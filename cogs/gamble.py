...
CHAR_REACTIONS = {
    "サラ": {
        1: "「ふん、まだ一回ですから。これくらいで勝った気になられちゃ困りますよ。」", # 耳のやつ
        2: "「いや、いやまだ、あの、次で取り返せますから、こんなもの……」", # 上着
        3: "「つ、次こそ取り返せるから……」",                        # セーター
        4: "「あ、あの……ボタンで勘弁してくれませんか……？；；」",        # シャツのボタン外し
        5: "「はい！　脱げばいいんでしょ脱げば！！」",               # シャツ
        6: "「な、なんか……世の中には足で興奮する人がいるとかいないとか……。……俺男ですよ…？」",    # 靴とか
        7: "「逆になんかイカサマやってるでしょあなた！！　ほらズボン！　はい！」",            # ズボン
        8: "「こんな、こんな格好で集中できるとでも？！；；」",
        9: "「いや、次は絶対俺が勝つので……。次負けたらもうあのほんと、なんでもするんで……。マジでこれは勘弁……」",
        10: "「……な、なんでもするって言った？　きき気のせいじゃないっすかねぇ…」",
    },
    "竹村しえら": {
